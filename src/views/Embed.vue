<template>
  <div class="hw1 container">
    <div class="pop-output">
      <div class="row">
        <iframe
          src="https://test-embedded-code-dot-web-app-dot-cuz-tech.appspot.com/embed/button?color=dark&ref=cvrvmr4b"
          frameborder="0"
          width="100%"
          height="55"
          scrolling="no"
      ...
      <div class="row">
        <iframe
          src="https://test-embedded-code-dot-web-app-dot-cuz-tech.appspot.com/embed/badge?ref=cvrvmr4b"
          frameborder="0"
          width="100%"
          height="85"
          scrolling="no"
    ...
    <div class="pop-sample-output">
      ...
      <div class="row">
        <iframe
          src="https://test-embedded-code-dot-web-app-dot-cuz-tech.appspot.com/embed/banner?color=light&ref=cvrvmr4b"
          frameborder="0"
          width="100%"
          height="190"
          scrolling="no"
      ...
      <div class="row">
        <iframe
          src="https://test-embedded-code-dot-web-app-dot-cuz-tech.appspot.com/embed/section?color=dark&ref=cvrvmr4b"
          frameborder="0"
          width="100%"
          height="220"
          scrolling="no"
